...
public interface ITransactionService
{
    ...
    Task<PagedResult<TransactionDto>> GetTransactionsPaginatedAsync(int pageNumber, int pageSize, string? search, string? status, string? type, DateTime? startDate = null, DateTime? endDate = null);
    ...
    Task<bool> ReverseDepositAsync(int transactionId, int adminId, string reason);
