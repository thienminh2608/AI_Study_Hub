...
public interface IDocumentService
{
    ...
    Task<DocumentResponseDto> ConfirmDocumentAsync(int userId, int documentId, string title, string sharingPermission, int? folderId);
    Task<DocumentResponseDto> ReplaceDocumentAsync(int userId, int pendingDocId, int duplicateDocId, string title, string sharingPermission, int? folderId);
    Task<DocumentResponseDto> KeepBothDocumentsAsync(int userId, int pendingDocId, string title, string sharingPermission, int? folderId);
    ...
    Task<bool> CheckDuplicateTitleAsync(int userId, string title, int? folderId, int? excludeDocId);
